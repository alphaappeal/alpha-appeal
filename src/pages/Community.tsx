...
import { Users, Search, Tag, Calendar, ChevronRight } from "lucide-react";
...
// Updated categories: Lifestyle changed to Strains, Reviews removed
const categories = [
  { id: "all", label: "All" },
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-background pb-20">
        ...
        <FloatingMenuButton>
          <MenuItem onClick={() => showPopup("Add Review", "Essential & Elite members can add review of strains they have experienced")}>
            Add Review
          </MenuItem>
          <MenuItem onClick={() => showPopup("My Diary", "Keep your lifted experiences up to date to ensure you repeat the best high")}>
            My Diary
          </MenuItem>
        </FloatingMenuButton>
